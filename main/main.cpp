...
#define MODEL_TXT "./Front-end language format/concat.txt"

std::set<std::string> Operator_Lib = {"abs", "add", "concat", "conv", "div", "leakyrelu", "slice", "tanh"};
std::map<std::string, std::unique_ptr<ONNX::Node>> NodeMap;
